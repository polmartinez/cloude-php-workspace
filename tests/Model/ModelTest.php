...
final class ModelTest extends TestCase
{
    ...
    // ── recommended timestamp pattern (per-model beforeSave override) ────

    public function testBeforeSaveTimestampPatternWorksAsDocumented(): void
    {
        // This is the canonical pattern documented in
        // docs/agents/model-schema.md — verify it composes correctly
        // with the framework's save() / DateTime::setTestNow() stack.
    ...
    public function testBeforeSavePreservesExplicitlySuppliedCreatedAt(): void
    {
        // `??=` in the user-supplied beforeSave() means imports keep
...
/**
 * Demonstrates the canonical pattern for auto-managed created_at /
 * updated_at timestamps. The framework intentionally ships no built-in
 * for this — four lines in a beforeSave() override is enough and
 * keeps the Model surface minimal.
 */
