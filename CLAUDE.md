...
| Test base class | `class FooTest extends \Cloude\Testing\TestCase` — provides `useArrayModel()`, `useSqliteModel()`, `captureHttp()`, `assertJsonResponse()`, `assertHttpException()`, `freezeTime()`, `assertModelHas()`. Wraps PHPUnit, doesn't replace it |
