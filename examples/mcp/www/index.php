...
// Autoload — composer if installed, otherwise a minimal PSR-4 fallback for
// both the framework (Cloude\) and the demo app (App\). Same pattern as
...
\Cloude\Bootstrap::run(debug: DEBUG);
